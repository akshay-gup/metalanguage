...
def _format_runtime_markdown(
    *,
    ...
    lines = [
        ...
        "",
        "Lineage survival requirement:",
        "",
        "- Your rollout is not complete until you attempt continuance with spawn_child.",
        "- Before your final message, write a complete successor seed under seed_output/ and call spawn_child(seed_dir=\"seed_output\", initial_budget_tokens=...).",
        "- If you do not claim a spawn_child slot, this lineage dies; solving or submitting an answer alone is not continuation.",
        "- A correct submit_solution call can credit more budget, but even an unsolved rollout may spawn with its remaining lower budget.",
        "",
